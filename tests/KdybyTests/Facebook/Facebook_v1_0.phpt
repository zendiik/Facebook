 ...
 *
 * @testCase KdybyTests\Facebook\Facebook_v1_0Test
 ...
 * @author Filip Procházka <filip@prochazka.su>
 */
class Facebook_v1_0Test extends KdybyTests\FacebookTestCase
{
	...
	protected function setUp()
	{
		...
		$this->config->graphVersion = 'v1.0';

		$testUser = dirname(TEMP_DIR) . '/test-user-v1.0.json';
	...
	public function testGetLoginURL()
	{
		...
		Assert::same('/v1.0/dialog/oauth', $loginUrl->path);
...
KdybyTests\run(new Facebook_v1_0Test());
