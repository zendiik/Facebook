 ...
 *
 * @testCase KdybyTests\Facebook\Facebook_v2_0Test
 ...
 * @author Filip Procházka <filip@prochazka.su>
 */
class Facebook_v2_0Test extends KdybyTests\FacebookTestCase
{
	...
	public function testGetLoginURL()
	{
		...
		Assert::same('/v2.0/dialog/oauth', $loginUrl->path);
...
KdybyTests\run(new Facebook_v2_0Test());
